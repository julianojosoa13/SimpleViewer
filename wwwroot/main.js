...
initViewer(document.getElementById("preview")).then((viewer) => {
  ...
  // Assuming 'viewer' is your Autodesk Forge Viewer instance
  viewer.addEventListener(
    ...
    function (event) {
      ...
      if (dbIds.length > 0) {
        const selectedId = dbIds[0]; // Get the first selected object (or iterate if multiple)

        // Get the properties of the selected object to retrieve the name
        viewer.getProperties(selectedId, function (props) {
          console.log("Object Id: " + selectedId);
          console.log("Object Name: " + props.name);
